...
RcppExport SEXP _ldsr_LDS_EM(SEXP ySEXP, SEXP uSEXP, SEXP vSEXP, SEXP initSEXP, SEXP niterSEXP, SEXP tolSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat >::type y(ySEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(LDS_EM(y, u, v, init, niter, tol));
    return rcpp_result_gen;
END_RCPP
}
// LDS_EM_restart_C
